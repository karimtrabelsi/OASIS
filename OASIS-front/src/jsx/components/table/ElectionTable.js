                    ...
                    <span className="input-group-text">
                     ...
                     <Button onClick={() => Swal.fire({
                        ...
                        html:
                           ...
                           '<input id="candidates" class="swal2-input" placeholder="Candidates (comma separated)">',
                        focusConfirm: false,
                        preConfirm: () => {
                           ...
                           if (!name || !club || !description || !startDate || !endDate || !candidates) {
                              Swal.showValidationMessage('Please fill in all fields');
                           }
                           return { name: name, club: club, description: description, startDate: startDate, endDate: endDate, candidates: candidates };
                        }
                     }).then(result => {
        ...
        `
                                    ...
                                    <Button onClick={() => {
                                       Swal.fire({
                                          ...
                                          html:
                                             '<input id="name" class="swal2-input" placeholder="Name" value="' + election.name + '">' +
                                             '<input id="club" class="swal2-input" placeholder="Club" value="' + election.club + '">' +
                                             '<textarea id="description" class="swal2-textarea" placeholder="Description">' + election.description + '</textarea>' +
                                             '<input type="date" id="startDate" class="swal2-input" placeholder="Start Date" value="' + moment(election.startDate).format('YYYY-MM-DD') + '">' +
                                             '<input type="date" id="endDate" class="swal2-input" placeholder="End Date" value="' + moment(election.endDate).format('YYYY-MM-DD') + '">' +
                                             '<input id="candidates" class="swal2-input" placeholder="Candidates (comma separated)" value="' + election.candidates + '">',
                                          focusConfirm: false,
                                          preConfirm: () => {
                                             const name = document.getElementById('name').value;
                                             const club = document.getElementById('club').value;
